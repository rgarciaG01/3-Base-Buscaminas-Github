...
public class ActionBoton implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		// Si abrircasilla() nos retorna true significa que no hay mina, por lo que
		// muestra las minas alrrededor,actualiza la puntuación y si a terminado el
		// juego (por que ya a conseguido los 80 puntos) se muestra el final del juego
		if (ventana.juego.abrirCasilla(i, j)) {
			...
			// En caso de que nos retorne false significa que hay una mina y se muestra un
			// mensaje de fin dle juego (por explosión)
		} else {
